function [a, a_prime, ct, cn, phi, F] = induction_factor(a, a_prime,R, r, ...
  cd, cl, B, sigma, lambda,  beta_correction)
...
% sigma -> solidity correction factor
  ...
  a_prime = beta_correction*a_prime_star + (1 - beta_correction)*a_prime;
