function [a, a_prime, ct, cn, phi, F] = induction_factor(a, a_prime,R, r, cd, cl, B, sigma, lambda)
...
% sigma -> solidity correction factor
  ...
  a = beta_correction*a_star + (1 - beta)*a;

  a_prime_star = (1 - a_prime)*sigma*ct/(4*F*sin(phi)*cos(phi));
  a_prime = beta_correction*a_prime_star + (1 - beta)*a_prime
