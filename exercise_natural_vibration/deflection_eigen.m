% function [Theta_y, Theta_z, u_y, u_z, Ky, Kz] = deflection_eigen(V0, r_item, n)
function [u] = deflection_eigen(r_item, n)
% This function computes the angle and deflaction of the blade loaded with
% unitary load on node n
parameters 
...
[r_vector, ~, beta_vector, ~] = load_blade_data(blade_filename);
...
% [py, pz, Theta_p] = internal_beam_loads_eigen(V0, n);
[py, pz] = internal_beam_loads_eigen(n);
...
% step 2 - curvature
for i = 1:r_item
  angle = beta_vector(i) + static_blade_data(i, 2)*pi/180;
