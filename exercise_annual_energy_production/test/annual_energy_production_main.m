...
V1 = 7.5:0.1:11.4; % build the vector with wind velocity
P1 = 7e6*ones(1, size(V1, 2)); % build the vector with the power of each 
% wind velocity (W)
[AEO1, CF1] = Annual_Energy_Output(P1, V1, P_rated, A_weibull, k_weibull);

V2 = 11.4:0.1:25; % build the vector with wind velocity
P2 = 10.64e6*ones(1, size(V2, 2)); % build the vector with the power of each 
% wind velocity (W)
