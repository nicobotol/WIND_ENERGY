...
Rm = 258; % magnetization resistance (seen from primary side) [ohm]
Xm = 786; % magnetization reactance (seen from primary side) [ohm]
Zm = Rm + 1j*Xm; % magnetization impedence (seen from the primary) [ohm]
